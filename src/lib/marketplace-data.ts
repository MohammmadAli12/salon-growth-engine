...
export const serviceDetails: Record<string, ServiceDetail> = {
  website: {
    ...
    packages: {
      ...
      prices: ["₹5,000", "₹10,000", "₹15,000"],
      rows: [
        { label: "Pages included", cells: ["1 long-form page", "3 pages", "Up to 10 pages"] },
        { label: "Mobile-first design", cells: ["yes", "yes", "yes"] },
        { label: "Online booking", cells: ["yes", "yes", "yes"] },
        { label: "Service pages", cells: ["Combined section", "1 services page", "Individual service pages"] },
        { label: "Gallery", cells: ["Basic grid", "Gallery page", "Gallery + before/after"] },
        { label: "Team / stylist profiles", cells: ["no", "Combined", "Dedicated page"] },
        { label: "Location pages", cells: ["no", "no", "Up to 3 areas"] },
  ...
  "google-profile": {
    ...
    packages: {
      ...
      rows: [
        { label: "Profile audit & optimisation", cells: ["yes", "yes", "yes"] },
        { label: "Outlets covered", cells: ["1", "1", "Up to 5"] },
        { label: "Google posts", cells: ["2 / month", "Weekly", "Weekly per outlet"] },
        { label: "Photo uploads", cells: ["4 / month", "8 / month", "8 / month per outlet"] },
        { label: "Review request engine", cells: ["no", "yes", "yes"] },
        { label: "Review responses", cells: ["no", "yes", "yes"] },
        { label: "Q&A seeding", cells: ["no", "yes", "yes"] },
        { label: "Reporting", cells: ["Monthly", "Monthly + call tracking", "Per-outlet monthly"] },
      ],
    },
  },
  "local-seo": {
    ...
    packages: {
      columns: ["Starter", "Growth", "Multi-Location"],
      rows: [
        { label: "Keywords tracked", cells: ["10", "25", "25 per outlet"] },
        { label: "Locality landing pages", cells: ["1", "3", "Up to 8"] },
        { label: "Technical SEO fixes", cells: ["Basic", "Full", "Full + site architecture"] },
        { label: "Citations & directories", cells: ["10", "30", "30 per outlet"] },
        { label: "Content pieces", cells: ["no", "1 / month", "2 / month"] },
        { label: "Internal linking & schema", cells: ["no", "yes", "yes"] },
        { label: "Rank reporting", cells: ["Monthly", "Monthly", "Per-outlet monthly"] },
        { label: "Strategy call", cells: ["no", "Monthly", "Bi-weekly"] },
      ],
    },
  },
  "google-ads": {
    ...
    packages: {
      columns: ["Launch", "Growth", "Scale"],
      rows: [
        { label: "Campaigns managed", cells: ["1 search campaign", "Up to 3", "Up to 6 + remarketing"] },
        { label: "Keyword research", cells: ["Core set", "Expanded", "Full + competitor gaps"] },
        { label: "Ad copy variants", cells: ["2", "4", "6 + testing cycle"] },
        { label: "Landing page", cells: ["Existing page", "1 built", "2 built + A/B test"] },
        { label: "Call & form tracking", cells: ["yes", "yes", "yes + CRM sync"] },
        { label: "Optimisation cadence", cells: ["Monthly", "Weekly", "Twice weekly"] },
        { label: "Reporting", cells: ["Monthly", "Monthly + call log", "Monthly + strategy review"] },
        { label: "Ad spend", cells: ["Billed by Google", "Billed by Google", "Billed by Google"] },
      ],
    },
  },
  "instagram-ads": {
    ...
    packages: {
      columns: ["Starter", "Growth", "Always-On"],
      rows: [
        { label: "Campaigns per month", cells: ["1 offer campaign", "2 campaigns", "3 + retargeting"] },
        { label: "Creatives produced", cells: ["3 statics", "2 reels + 4 statics", "4 reels + 8 statics"] },
        { label: "Shoot direction", cells: ["Shot list only", "Remote direction", "On-site shoot day"] },
        { label: "Audience testing", cells: ["1 audience", "3 audiences", "Continuous testing"] },
        { label: "Lead routing", cells: ["DM / form", "WhatsApp automation", "WhatsApp + CRM"] },
        { label: "Creative refresh", cells: ["no", "Monthly", "Bi-weekly"] },
        { label: "Reporting", cells: ["Monthly", "Monthly", "Monthly + strategy call"] },
        { label: "Ad spend", cells: ["Billed by Meta", "Billed by Meta", "Billed by Meta"] },
      ],
    },
  },
  "whatsapp-api": {
    ...
    packages: {
      columns: ["Essential", "Growth", "Pro"],
      rows: [
        { label: "Verified business sender", cells: ["yes", "yes", "yes"] },
        { label: "Message templates", cells: ["3", "8", "Unlimited"] },
        { label: "Appointment reminders", cells: ["yes", "yes", "yes"] },
        { label: "Rebooking sequences", cells: ["no", "yes", "yes + win-back"] },
        { label: "Broadcast campaigns", cells: ["1 / month", "4 / month", "Weekly"] },
        { label: "Shared team inbox", cells: ["1 agent", "3 agents", "Unlimited agents"] },
        { label: "Booking system integration", cells: ["no", "yes", "yes + CRM sync"] },
        { label: "Reporting", cells: ["Monthly", "Monthly", "Monthly + optimisation"] },
      ],
    },
  },
  "ai-automation": {
